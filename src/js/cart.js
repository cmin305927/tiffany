...
$(function(){
        ...
        str += `
                ...
                <div class="row buyInfo">
                    ...
                    <p class="col-sm-4 operate">
                        ...
                        <button class="btn btn-danger clearBox">清空购物车</button>
                        <button class="btn btn-primary goOn">继续购物</button>
                    </p>
                </div>
                </div>
            </div>
    ...
    $('.on').on('click', '.pay', function(){
        window.location.href = './pay.html'
    })


    $('.on').on('click', '.clearBox', function(){
        cart.length = 0
